    ...
    public boolean giveReward(final Player player, final String challenge) {
        ...
        if (Settings.challenges_enableEconomyPlugin && VaultHandler.econ != null) {
            ...
            if (getInstance().getPlayer(player.getUniqueId()).checkChallenge(challenge)) {
                ...
                player.sendMessage(ChatColor.YELLOW + "Repeat currency reward: " + ChatColor.WHITE + getInstance().getChallengeConfig().getInt("options.challenges.challengeList." + challenge + ".repeatCurrencyReward") + " " + VaultHandler.econ.currencyNamePlural());
            } else {
